...
class Developer extends Component {
    ...
    return (
      <div className="dev_contact_info">
        ...
        <div className="dev_contact_single">
          ...
          />
          : <a href="mailto:vahag85yan@gmail.com">vahag85yan@gmail.com</a>
        </div>
        <div className="dev_contact_single">
          <TranslatableText
            dictionary={{
          ...
          :{" "}
          <Link
            to={{ pathname: "https://www.linkedin.com/in/vahagn85/" }}
            target={"_blank"}
          >
            Linkedin
          </Link>
  ...
  render() {
    ...
    const contactInfo = open ? this.renderContactInfo() : null;
      ...
      >
        ...
        <div className={styleInfo}>
          ...
          <div className="dev_contact_cv">
            <div className="dev_btn btn_contact" onClick={this.handlerOpen}>
              {contacts}
            </div>
            <LanguageConsumer>
              {({ language }) => {
                ...
                return (
                  <a
                    href={langCv}
                    download={"Vahagn-Ulikhanyan-cv-" + nameCv}
                    className="dev_btn btn_cv"
                  >
                    <span>
